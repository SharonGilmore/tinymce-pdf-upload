                ...
                input.onchange = function (e) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        fetch("".concat(fileupload_url), {
                            ...
                            if (res.error)
                                throw new Error();
                            editor.insertContent("<a target=\"_blank\" href=\"".concat(res.url, "\">").concat(res.filename, "</a>"));
                        })
                            .catch(function () { return alert("Unable to upload file"); });
                        return [2 /*return*/];
                    });
                }); };
            },
